document.addEventListener("DOMContentLoaded", function () {
  // Check if we're in the testing area
  const booksContainer = document.getElementById("books-component-container");
  if (!booksContainer) {
    return; // Exit if not in testing area
  }

  // Theme toggle functionality
  const themeToggle = document.getElementById("theme-toggle");
  const body = booksContainer; // Use container instead of body
